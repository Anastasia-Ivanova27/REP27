...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure MIsDelClick(Sender: TObject);
    procedure MIsoClick(Sender: TObject);
    procedure MIsoDelClick(Sender: TObject);
...
procedure TForm1.MIsDelClick(Sender: TObject);
begin

end;

procedure TForm1.MIsoDelClick(Sender: TObject);
begin
