...
type
  ...
  TForm1 = class(TForm)
    ...
    procedure MIsDClick(Sender: TObject);
    procedure MIsoClick(Sender: TObject);
    procedure MIsoDClick(Sender: TObject);
...
procedure TForm1.MIsDClick(Sender: TObject);
begin

end;

procedure TForm1.MIsoDClick(Sender: TObject);
begin
